...
<body>
    <header class="header">
        <div class="container">
            <div class="logo_menu">
                <img src="img/logo-clínica-luz-divina.png" alt="logo" class="logo" />
            </div>
            <nav class="navbar">
                <ul class="nav-links">
    ...
    <div class="preload">
        <div class="preloadanimation"></div>
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="300.000000pt" height="116.000000pt" viewBox="0 0 300.000000 116.000000" preserveAspectRatio="xMidYMid meet">
    ...
    <div class="slider-container">
        <div class="slider" id="slider">
            <div class="slide"><a href="#"><img src="img/1-carrusel.jpg" alt="Imagen 1"></a></div>
            <div class="slide"><a href="#"><img src="img/2-carrusel.jpg" alt="Imagen 2"></a></div>
            <div class="slide"><a href="#"><img src="img/3-carrusel.jpg" alt="Imagen 3"></a></div>
            <div class="slide"><a href="#"><img src="img/4-carrusel.jpg" alt="Imagen 4"></a></div>
        </div>
...
<footer>
    <div class="footer">
        <div class="footer_content">
            <div class="row_1">
                <div class="footer_logo"><img src="img/logo-clínica-luz-divina.png" style="width: 150px"></div>
                <div class="row_1_text">
                    <img src="data:image/png;base64,"/>
                    <p>Av. Angélica Gamarra 902 Santiago de Surco</p>
                </div>
                <div class="row_1_text">
                    <img src="data:image/png;base64,"/>
                    <p>(+51) 982134765</p>
                </div>
            </div>
            <div class="row_2">
                <h2>Red de clínicas asociadas</h2>
                <p>Clínica San Gabriel</p>
                <p>Clínica Santa Martha del Sur</p>
                <p>Clínica Jesús del Norte</p>
                <p>Clínica San Juan Bautista</p>
                <p>Clínica San Pablo Trujillo</p>
                <p>Clínica San Pablo Arequipa</p>
                <p>Chacarilla - Medicina Física y Rehabilitación</p>
            </div>
            <div class="row_3">
                <h2>Unidades disponibles</h2>
                <p>Ambulancias Cardiomovil</p>
                <p>Dermoesthetik San Pablo</p>
                <p>Medik Center San Pablo - Los Olivos</p>
                <p>San Pablo Salud</p>
                <p>Diagnóstico por Imagenes Tomomedic Qualab</p>
            </div>
            <div class="row_4">
                <h2>Nuestras Redes</h2>
                <div class="redes">
                    <a href="https://www.instagram.com/mr_vinill_23/" target="_blank"><img src="data:image/png;base64,"/></a>
                    <a href="https://www.facebook.com/profile.php?id=61553997931617" target="_blank"><img src="data:image/png;base64,"/></a>  
                </div>
            </div>
        </div>
        <div class="footer_Bottom">
            ...
            <div class="terms">
                ...
                <a>Derechos y Deberes</a>
            </div>
        </div>
    </div>
</footer>
    <script src="https://code.jquery.com/jquery-3.7.1.min.js" integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script>
    <script src="js/clínica-luz-divina.js"></script>
</body>
</html>